...
export const LAYER_CONFIGS: LayerConfig[] = [
  ...
  { id: 'nfm-hotspots', label: 'NFM Hotspots', group: 'risk', color: '#84cc16', defaultVisible: false,
    description: 'Natural Flood Management Heat Maps — EA priority areas where NFM interventions (leaky dams, tree planting, wetlands) would be most effective.' },

  // --- Reference (static/historical) ---
  { id: 'wfd-catchments', label: 'WFD River Catchments', group: 'reference', color: '#0891b2', defaultVisible: false,
    description: 'WFD River Water Body Catchments Cycle 2 — Defra catchment boundaries linked to Water Framework Directive waterbodies.' },
  { id: 'schools', label: 'Schools (State-Funded)', group: 'reference', color: '#f59e0b', defaultVisible: false,
    description: 'Edubase state-funded schools — ~22K maintained, academy, free and special schools. Key flood vulnerability indicator for evacuation planning.' },
  { id: 'hospitals', label: 'Health & Care (CQC)', group: 'reference', color: '#ec4899', defaultVisible: false,
    description: 'CQC-regulated health & care locations — hospitals, GP surgeries, care homes, dentists, clinics. ~57K locations for flood vulnerability analysis.' },
  { id: 'bathing-waters', label: 'Bathing Water Quality', group: 'reference', color: '#06b6d4', defaultVisible: false,
    description: 'EA designated bathing waters — ~460 sites colour-coded by latest water quality classification (Excellent / Good / Sufficient / Poor).' },
  { id: 'ramsar-wetlands', label: 'Ramsar Wetlands', group: 'reference', color: '#059669', defaultVisible: false,
    description: 'Ramsar Convention wetlands of international importance (England) — 73 designated sites, 1 291 polygons from Natural England.' },
  { id: 'water-company-boundaries', label: 'Water Company Boundaries', group: 'reference', color: '#7c3aed', defaultVisible: false,
    description: 'Ofwat water company service area boundaries — 432 polygons covering 27 companies (regional, water-only & NAV operators).' },
  { id: 'edm-overflows', label: 'Storm Overflows (EDM 2024)', group: 'reference', color: '#b91c1c', defaultVisible: false,
    description: 'EDM 2024 storm overflow discharge points — 16 625 monitored overflows from 11 water companies, colour-coded by spill count.' },
  { id: 'winep-overflows', label: 'WINEP Overflows (Under Investigation)', group: 'reference', color: '#f59e0b', defaultVisible: false,
    description: 'WINEP storm overflows under investigation — 4 320 intermittent discharge sites from 10 water companies, colour-coded by action type.' },
