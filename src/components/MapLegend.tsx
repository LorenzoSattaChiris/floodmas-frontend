...
const LEGEND_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { color: '#0891b2', label: 'WFD River Catchments', shape: 'polygon' as const },
      { color: '#16a34a', label: 'NFM Hotspots', shape: 'polygon' as const },
      { color: '#f97316', label: 'Schools (State-Funded)', shape: 'circle' as const },
      { color: '#ef4444', label: 'Health & Care (CQC)', shape: 'circle' as const },
      { color: '#22c55e', label: 'Bathing Water — Excellent', shape: 'circle' as const },
      { color: '#86efac', label: 'Bathing Water — Good', shape: 'circle' as const },
      { color: '#eab308', label: 'Bathing Water — Sufficient', shape: 'circle' as const },
      { color: '#ef4444', label: 'Bathing Water — Poor', shape: 'circle' as const },
      { color: '#059669', label: 'Ramsar Wetlands', shape: 'polygon' as const },
      { color: '#7c3aed', label: 'Water Company Boundaries', shape: 'polygon' as const },
      { color: '#22c55e', label: 'Storm Overflow — 0 spills', shape: 'circle' as const },
      { color: '#eab308', label: 'Storm Overflow — Low (1–9)', shape: 'circle' as const },
      { color: '#f97316', label: 'Storm Overflow — Medium (10–39)', shape: 'circle' as const },
      { color: '#ef4444', label: 'Storm Overflow — High (40–99)', shape: 'circle' as const },
      { color: '#991b1b', label: 'Storm Overflow — Very High (≥100)', shape: 'circle' as const },
      { color: '#eab308', label: 'WINEP — Investigation', shape: 'circle' as const },
      { color: '#3b82f6', label: 'WINEP — Monitoring', shape: 'circle' as const },
      { color: '#22c55e', label: 'WINEP — Implementation', shape: 'circle' as const },
      { color: '#a855f7', label: 'WINEP — No Deterioration', shape: 'circle' as const },
